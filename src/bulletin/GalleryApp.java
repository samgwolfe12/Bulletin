...
public class GalleryApp extends Application {
	...
	public void createMenu() {
		...
		EventHandler<ActionEvent> exiting = event -> System.exit(0);
	...
	/**
	 * Method to create the extra credit help menu. The help menu has a about item.
	 */
	public void createHelp(MenuButton menuButton2) {
		...
		EventHandler<ActionEvent> helping = event -> {
